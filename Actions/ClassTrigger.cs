...
{
	public class ClassTrigger : BitStaticTrigger
	{
		private Class _class;

		public ClassTrigger(Class @class, TriggerType trigger)
			: base(trigger)
		{
			_class = @class;
		}

		public ClassTrigger(Class @class, BitStaticTrigger lowerTrigger = null)
			: base(lowerTrigger)
		{
			_class = @class;
		}
