...
{
	public class AttackAction : BitAction
	{
		...
		public AttackAction(BitActionAnimation meleeAnimation, BitActionAnimation rangedAnimation, ParamIntValueClass val, Common.BoolDelegate rangeDelegate)
			: base(meleeAnimation)
		{
		...
		public override void PerformAction(IEnumerable<KeyValuePair<Vector2, FieldMonster>> monsters, Action<bool, FieldElement> onCompleted)
		{
			...
			if (!((FieldMonster)_myMonster).canAttack)
			{
